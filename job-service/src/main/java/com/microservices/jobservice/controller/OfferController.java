...
import com.microservices.jobservice.dto.OfferDto;
...
import com.microservices.jobservice.service.OfferService;
...
public class OfferController {
    ...
    public ResponseEntity<List<OfferDto>> getAllOffers(){
        return ResponseEntity.ok(offerService.getAllOffers().stream().map( offer -> modelMapper.map(offer, OfferDto.class)).toList());
    }
